...
<div class="wrapper-user">
    <div class="user">
        <div class="row">
            <div class="col-12 col-sm-3 text-center" style="min-height: 100px; margin-left: 35px; margin-bottom: 35px;">
                <div class="user-card">
                ...
                <a href="{{ route('addProduct') }}" class="btn btn-add-product btn-primary mt-4">Добавить товар</a>
            </div>
